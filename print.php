	...
	$sql_lable_join="select  CUSTOMER.CUS_FNAME,CUSTOMER.CUS_LNAME,LABLE.IMG,CATEGORY.CAT_NAME,LABLE.LABLE_WIDTH,
							 ...
							 and  LABLE.CUS_PHONE=CUSTOMER.CUS_PHONE and LABLE.CAT_ID = CATEGORY.CAT_ID and LABLE.STATUS='ปริ้น' order by LABLE.LABLE_ID desc";
	}
	else{
	$fname=$_POST['fname'];
	$sql_lable_join="select  CUSTOMER.CUS_FNAME,CUSTOMER.CUS_LNAME,LABLE.IMG,CATEGORY.CAT_NAME,LABLE.LABLE_WIDTH,
							 ...
							 LABLE.STATUS,LABLE.LABLE_ID
							 from LABLE,STAFF,CUSTOMER,CATEGORY where LABLE.STAFF_ID=STAFF.STAFF_ID 
							 and  LABLE.CUS_PHONE=CUSTOMER.CUS_PHONE and LABLE.CAT_ID = CATEGORY.CAT_ID and LABLE.STATUS='ปริ้น' and CUSTOMER.CUS_FNAME like '%$fname%' order by LABLE.LABLE_ID desc";
	}
	...
	<br>
					...
					<table class="container" border="1">
							...
							?>
								...
								<th bgcolor='<?php echo $color;?>'><?php echo  $row_lable_join['ORDER_DAY'];?></th>
								<th bgcolor='<?php echo $color;?>'><?php echo  $row_lable_join['PICK_UP_DATE'];?></th>
