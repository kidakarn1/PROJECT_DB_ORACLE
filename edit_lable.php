			   ...
			   <br>
				 ...
				 <div class="form-group">
					 <label class="col-sm-2 control-label" for="width">กว้าง/เมตร</label>
					  <div class="col-sm-2">
						  <input type="number" class="form-control" id="width1" name="width" value="<?php echo $row['LABLE_WIDTH'];?>" placeholder="ความกว้าง" required/>
					  </div>
					  <label class="col-sm-2 control-label" for="height" >สูง/เมตร</label>
					   <div class="col-sm-2">
						  <input type="number" class="form-control" id="height1" name="height" value="<?php echo $row['LABLE_HEIGHT'];?>"placeholder="ความสูง" required/>
					   </div>
				 </div>
			   <br>
			   <br>
